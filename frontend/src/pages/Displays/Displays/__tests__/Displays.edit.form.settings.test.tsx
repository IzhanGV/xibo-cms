...
describe('Display - edit form: Settings tab', () => {
  ...
  //
  // - Settings Profile (SelectDropdown): renders as a plain <div> with no ARIA
  //   role and its <label> has no htmlFor. Flag for /review-accessibility.
  //
  // - Profile settings override table: dynamically populated from the active
  //   display profile. Requires integration-level testing with a real profile
  //   fixture; not covered here.
  // ---------------------------------------------------------------------------
});
